...
public class TaskStatistics {
    ...
    private final Map<Priority, Integer> tasksByPriority;
    private final Map<Category, Integer> tasksByCategory;
    private final Map<Status, Integer> tasksByStatus;
    ...
    private void calculateStatistics(List<Task> tasks) {
        for (Task task : tasks) {
            ...
            if (task.getStatus() == Status.COMPLETED) {
                ...
                pendingTasks++;
            } else if (task.getStatus() == Pending.IN_PROGRESS) {
                inProgressTasks++;
            }
